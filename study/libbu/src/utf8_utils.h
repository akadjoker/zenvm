...
inline int Utf8Encode(int value, uint8_t* bytes)
{
  if (value <= 0x7f)
  {
    *bytes = value & 0x7f;
...
inline int Utf8EncodeNumBytes(int value)
{
...
inline int Utf8Decode(const uint8_t* bytes, uint32_t length)
{
...
inline int Utf8DecodeNumBytes(uint8_t byte)
{
